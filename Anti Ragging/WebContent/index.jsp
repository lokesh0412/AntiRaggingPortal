				...
				<nav class="navbar navbar-default zero_mp ">
					...
					<div class="collapse navbar-collapse zero_mp"
						...
						<ul class="nav navbar-nav navbar-right main_menu">
							...
							<li><a href="#welcome" onclick="document.getElementById('id01').style.display='block'">About</a></li>
							<li><a href="#portfolio">Information Pack</a></li>
							<li><a href="login.jsp">Login</a></li>
							<li><a href="signup.jsp">Sign up</a></li>
							<li><a href="Feedback.jsp">Feedback</a></li>
							<li><a href="#blog">FAQs</a></li>
							<li><a href="#contact" onclick="document.getElementById('id02').style.display='block'">contact us</a></li>
						</ul>
					</div>
					<!-- /.navbar-collapse -->
				</nav>
...
<!-- -->
                        ...
                        <div class="slider_overlay">
                            ...
                            <div class="carousel-caption">
                                <div class="slider_text">
								   ...
								   <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-green">Read More</button>
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content">
	  ...
	  <p></p>
	  <br>
        <p>Ragging has ruined countless innocent lives and careers. In order to eradicate it, Hon’ble Supreme Court in Civil Appeal No. 887 of 2009, passed the judgement wherein guidelines were issued for setting up of a Central Crisis Hotline and Anti-Ragging database. 

 </p>
 <br>
        <p>In accordance with the orders, UGC (University Grants Commission), Govt. of India has developed this web portal. </p>
	<br>	<p>This portal will contain:
</p>
<br>
<p>
       1. A form for registering complaints regarding ragging.
</p>
<br>
<p>
       2. Record of registered complaints received and the status of the action taken. 
</p><br><p>
The aim of the portal is to eliminate ragging in all its forms from universities, deemed universities and other higher educational institutions in the country. This will be achieved by preventing its occurrence and punishing those who indulge in ragging, in accordance with the Supreme Court Regulations.</p>
  <br>
<p></p>  </div>
...
<br>
<p>1.Name:Rajat Yadav</p>
<p>	 Mobile No.:8887737181<p>
<p>	 Email:rajatrkrockstar@gmail.com</p>	
<br>
<br>
 <p>1.Name:Roopak Singh</p>
<p>	 Mobile No.:9457526577<p>
<p>	 Email:singhroopak5@gmail.com</p>	
<br>
<br>
<p>1.Name:Lokesh Kr. Tiwari</p>
<p>	 Mobile No.:8470988708<p>
<p>	 Email:lokesh0412@gmail.com</p>	
<br>
<br>
      <footer class="w3-container w3-green">
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-6">
					<div class="copyright">
						<p>
							@ 2018 - Design By <span><a href="">&#9798;</a></span>
						</p>
					</div>
				</div>
				<div class="col-md-6">
