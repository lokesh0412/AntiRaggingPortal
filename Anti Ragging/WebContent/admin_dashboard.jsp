...
<div class="container" id="home">
	<div class="row text-center ">
		<div class="col-md-3 head-main ">
			...
			<h3>
				<a href="admin_dashboard.jsp" style="color: #47d147">HOME</a>
			</h3>
		...
		<div class="col-md-3 head-main">
			...
			<h3>
				<a href="allComplains.jsp" style="color: #47d147">COMPLAINS</a>
			</h3>
		...
		<div class="col-md-3 head-main">
			...
			<h3>
				<a href="" style="color: #47d147">STATUS</a>
			</h3>
...
<section class="for-full-back color-light " id="about">
	<div class="container">
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<h4>
					<strong>Ragging has ruined countless innocent lives and
						careers. In order to eradicate it, Hon’ble Supreme Court in
		...
		<!--footer Section -->
		<div class="for-full-back " id="footer">2018 www.yourdomain.com
